...
public class Setup
{
	...
	public static void main(String args[]) throws ClassNotFoundException,SQLException
	{
		...
		try
		{
			...
			String createTeam = "CREATE TABLE Team (teamID INTEGER PRIMARY KEY AUTO_INCREMENT, name VARCHAR(50) NOT NULL, affiliation VARCHAR(200) NOT NULL, supervisor INTEGER NOT NULL, teamKey INTEGER, FOREIGN KEY (supervisor) REFERENCES SuperUser(userID)) ENGINE=INNODB;";
			...
			String createCard = "CREATE TABLE Card (cardID INTEGER PRIMARY KEY AUTO_INCREMENT, listID INTEGER, name VARCHAR(50) NOT NULL, priority INTEGER CHECK (priority <= 6 AND priority >= 0), description VARCHAR(1000) NOT NULL, dueDate DATETIME NOT NULL, archived VARCHAR(5) CHECK (archived IN ('True','False')), finished VARCHAR(5) CHECK (finished IN ('True','False')), FOREIGN KEY (listID) REFERENCES List (listID)) ENGINE=INNODB;";
